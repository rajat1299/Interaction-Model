...
from im.schema.events import (
    ...
    AnnotationPayload,
    CancelAckPayload,
    CheckpointAmbiguousMark,
    CheckpointAppliedMark,
    CheckpointDelegatePriorUse,
...
_FIELD_ORDER: dict[type[BaseModel], tuple[str, ...]] = {
    ...
    CheckpointAmbiguousMark: ("mark_event_id", "instruction_text", "targets", "age_ms"),
    CheckpointRecentEvent: ("event_id", "rendered"),
    CheckpointDisposition: ("event_id", "policy_seq", "relation", "state"),
    CheckpointHashes: (
        "schema_hash",
        "spec_hash",
        "prompt_hash",
